...
vim.keymap.set("n", "<leader>fw", function()
  telescope_builtin.grep_string({ cwd = vim.uv.cwd() })
end, {})
vim.keymap.set("n", "<leader>cp", function()
  telescope_builtin.live_grep({ cwd = vim.uv.cwd() })
end, {})
...
local on_attach = function(_, bufnr)
  ...
  local function goto_diagnositc(next, severity)
    return function()
...
require("typst-preview").setup({
  ...
  open_cmd = "google-chrome-stable --app=%s --hide-scrollbars",
})
